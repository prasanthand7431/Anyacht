package com.anyacht.app.adapter;
...
import com.anyacht.app.activity.YatchDetailsActivity;
...
public class BookingAdapter extends BaseAdapter {
    ...
    public BookingAdapter(BookingList bookingList, ArrayList<BookingDetails> bookingDetails, BookingList bookingList1) {


        this.bookingDetailsArrayList = bookingDetails;
        this.context = bookingList;
        this.inflater = LayoutInflater.from(bookingList);
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.adapter_bookingl_list, null);
